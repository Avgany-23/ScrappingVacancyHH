...
if __name__ == '__main__':
    ...
    cities = ['AllRegions']         # Список регионов поиска. Можно выбирать и другие
    ...
    # Создание ссылки с указанными параметрами и получение вакансий по ссылке main_url с указанными keywords
